...
var snowStorm = (function(window, document) {
  ...
  function doStart() {
    ...
    else if(!storm.excludeMobile || !isMobile) {
      doDelayedStart();
    }
    // event cleanup
...
$('.toggle-sound').click(function() {
  ...
  let tooglesound = document.getElementById("toogle");
  let textarea = document.getElementById("text-area");
  let textarea2 = document.getElementById("text-area2");
  let textarea3 = document.getElementById("text-area3");
  let submitbtn = document.getElementById("submit");
  let santafly = document.getElementById("sanatfly");
  let santawalk = document.getElementById("santawalk");
  ...
  function myFunction(){
    tooglesound.style.display="none";
    textarea.style.display ="none";
    textarea2.style.display ="none";
    santafly.style.display="none";
    santawalk.style.display ="none";
    textarea3.innerText ="What is your name?";
    SleighRide.stop();Jingle2.stop();hohoho.stop();	
    SantaLaughing.stop();
  ...
  submitbtn.addEventListener('click', function() {
    ...
    setTimeout(
      function() {
        tooglesound.style.display="inline";
        textarea.style.display ="block";
        textarea2.style.display ="block";
        santafly.style.display="inline";
